...
$(document).ready(function () {
  ...
  client.get(
    "https://api.github.com/repos/D3VSJ/BetterDiscordPanel/releases/latest",
    function (response) {
      ...
      new Noty({
        ...
        closeWith: ["button"],
        text:
          '<a href="https://github.com/D3VSJ/BetterDiscordPanel" target="blank" class="welcome-tag">Welcome to BetterDiscordPanel v' +
          version +
          '! <iframe src="https://ghbtns.com/github-btn.html?user=D3VSJ&repo=BetterDiscordPanel&type=star&count=true" frameborder="0" scrolling="0" width="150" height="20" title="GitHub"></iframe></a>',
        dismissQueue: true,
      }).show();
